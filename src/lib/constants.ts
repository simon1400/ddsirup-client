...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://ddsirup.co';

/** Order subtotal (CZK) from which shipping is free — shown in the top announcement bar */
